        ...
        <div class="px-4 sm:px-6 lg:px-8 border-b-8">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="text-2xl text-gray-400">{{$movie->getTranslation('name', 'name_'.app()->getLocale())}} all Quotes</h1>
                    <p class="mt-2 text-sm text-gray-400">A list of all quotes for movie called {{$movie->getTranslation('name', 'name_'.app()->getLocale())}}</p>
                </div>
